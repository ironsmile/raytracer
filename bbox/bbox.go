...
// Inside tells whether a point is inside the bounding box nor not.
...
// MaximumExtend tells the caller which of the three axes is longest:
// 0 -> X
// 1 -> Y
// 2 -> Z
...
// Union returns a bounding box which encompasses the the two input boxes.
...
// any unions with it would result in a bounding box exatly the same as the other bbox
// or point.
func Null() *BBox {
